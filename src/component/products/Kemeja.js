...
class Kemeja extends Component{
    ...
    async componentWillMount(){
        ...
        window.scrollTo(0,0)
        await this.props.getProductByCategory(2)
        console.log(this.props.productsSTATE.length)
    }
...
export default connect(mapStatetoProps, {getProductByCategory, clearProduct})(Kemeja)